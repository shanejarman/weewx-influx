...
def get_database_dict_from_config(config_dict, database):
    ...
    # This requires a bit of database-specific knowledge, but it's easier than some sort of
    # dependency injection from the SQLite code...
    if 'SQLITE_ROOT' in database_dict:
        database_dict['SQLITE_ROOT'] = os.path.join(config_dict['WEEWX_ROOT'],
                                                    database_dict['SQLITE_ROOT'])
